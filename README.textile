...
<code>cd ~/ # cd to your home directory</code>
<code>git clone http://github.com/twe4ked/dotfiles.git .dotfiles # Clone the dotfiles.</code>
<code>cd ~/.dofiles # cd to the .dotfile directory</code>
<code>rake # Setup symlinks (do this from the .dotfiles directory)</code>
