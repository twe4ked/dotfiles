...
@rp@ looks for a tmp directory, if there is no tmp directory it prompts you to create one.
Once it finds a tmp directory it touches tmp/restart.txt to tell passenger to restart.
